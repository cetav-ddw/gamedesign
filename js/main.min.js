...
function domReady() {
    ...
    if (document.querySelector(".grid")) {
        var options = {
            srcNode: "img",
            // grid items (class, node)
            margin: "5px",
            // margin in pixel, default: 0px
            width: "100px",
            // grid item width in pixel, default: 220px
            max_width: "500px",
            // dynamic gird item width if specified, (pixel)
            resizable: true,
            // re-layout if window resize
